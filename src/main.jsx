...
const APK_DOWNLOAD_URL = 'https://github.com/Erzkanzler2k/plenka/releases/latest/download/Plenka-v2.2.24-release.apk'
    ...
    <div className="site-shell">
      <header className="site-header">
        <nav className="container nav" aria-label="Основная навигация">
          ...
          <button className="nav-download" onClick={download}>Скачать APK v2.2.24 <ArrowUpRight size={16} /></button>
      ...
      <main id="top">
        <section className="hero container">
          <div className="hero-topline"><span>ПЛЕНКА v2.2.24 / ANDROID 8+</span><span>Помощник в выборе фильма</span><span>КАТАЛОГ НА TMDB</span></div>
          <div className="hero-layout">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                <button className="button button-gradient" onClick={download}>Скачать APK (v2.2.24) <ArrowUpRight size={18} /></button>
      ...
      {toast && <div className="toast" role="status"><Check size={17} /> Начинается загрузка APK v2.2.24</div>}
    </div>
  )
}
