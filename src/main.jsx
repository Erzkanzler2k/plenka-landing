...
const APK_DOWNLOAD_URL = 'https://github.com/Erzkanzler2k/plenka/releases/latest/download/Plenka-v2.2.26-release.apk'
    ...
    <div className="site-shell">
      <header className="site-header">
        <nav className="container nav" aria-label="Основная навигация">
          ...
          <button className="nav-download" onClick={download}>Скачать APK v2.2.26 <ArrowUpRight size={16} /></button>
      ...
      <main id="top">
        <section className="hero container">
          <div className="hero-topline"><span>ПЛЕНКА v2.2.26 / ANDROID 8+</span><span>Помощник в выборе фильма</span><span>КАТАЛОГ НА TMDB</span></div>
          <div className="hero-layout">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                <button className="button button-gradient" onClick={download}>Скачать APK (v2.2.26) <ArrowUpRight size={18} /></button>
        ...
        <section className="devices" id="devices"><div className="container devices-inner"><div><p className="kicker"><span />Релиз v2.2.26 для Android</p><h2>Кино<br /><i>в кармане.</i></h2><p className="devices-copy">Пленка работает на Android 8.0 и выше: свайп-лента с мульти-жанрами, поиск по персонам, трейлеры, избранное, история с таймкодами и встроенный плеер с PiP.</p><button className="button button-light" onClick={download}>Скачать APK v2.2.26 <ArrowUpRight size={18} /></button></div><div className="device-list"><div><span className="device-badge">TMDB</span><span>Каталог</span><small>Фильмы, сериалы и персоны</small></div><div><span className="device-badge">PiP</span><span>Плеер</span><small>Картинка в картинке</small></div><div><span className="device-badge">8.0+</span><span>Android</span><small>Минимальная версия</small></div></div></div></section>
      ...
      {toast && <div className="toast" role="status"><Check size={17} /> Начинается загрузка APK v2.2.26</div>}
    </div>
  )
}
